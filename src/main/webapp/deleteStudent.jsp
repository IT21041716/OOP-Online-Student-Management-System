...
<body class="w3-black">
		...
		<form action ="delete" method ="post">
			<label for="Sname" class ="lable1">Username</label>
			<input type="text" class="box1" name ="Sname" placeholder="type username of student"><br><br>
	
			<input type="submit"name ="submit" class="submit"value="remove student">
		</form>
	
		<p class ="para">Note:If you want to suspend a students regarding a reasonable case you should enter 
		student's Username and click "remove student" button 
			then you can restrict the that student's activities,after remove the student that student cannot log our system 
			and he cannot do any academic activities. thank you </p>

...
<body class="w3-black">
		...
		<br>
		<h1><center><b>Admin view</b></center></h1>
		<br><br><br>
	<c:forEach var="us" items="${userdetails}">			
	 ...
	 <div class="blank">
			...
			<a href ="${AdminUpdate}">
				<input type ="button" name ="update" class="button" value="change my password"><br><br>
			</a>
			
		<!-- check registration process -->	
			<a href ="CheckRegistrations.jsp">
				<input type ="button" name ="check" class="button" value="Check Available registration forms"><br><br>
			</a>

		<!-- manage students accounts delete and update-->
			<a href="deleteStudent.jsp">
				<input type ="button" name ="delete" class="button"value ="delete Students account ">
			</a>

...
<body class="w3-black">
		...
		<div class="w3-padding-large" id="main">
		  ...
		  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
		    <h1 class="w3-jumbo"><span class="w3-hide-small">Royal</span> college</h1>
		    <p>Colombo 07.</p>
		  ...
		  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
		    <h2 class="w3-text-light-grey">An Experience That Lasts a Lifetime.</h2>
		    ...
		    <p>Since 1835, The Royal College has been devoted to producing gentlemen capable of spearheading change and advancement. Its multicultural environment fosters the free exchange of ideas and the celebration of diverse identities. Possessing a rich history of tradition but never limited by it, the College has always maintained adaptation as the key to excellence.  </p>
		     ...
		     <h2 class="w3-text-light-grey">Academics</h2>
		    <hr style="width:200px" class="w3-opacity">
		    <p>
		    Education at the College transcends book and quill, seeking to mould a holistic personage out of every student. Employing the finest teachers in every field and equipped to support all learning needs, the Royal College strives to produce individuals who make meaningful contributions to society.
		     </p>
		    
		     <h2 class="w3-text-light-grey">Clubs & Societies</h2>
		    <hr style="width:200px" class="w3-opacity">
		    <p>
		    The Royal College celebrates the freedom given to its students to express themselves. The College provides a plethora of clubs & societies to select from and the liberty to found a new community. This is the birthplace of idea-driven individuals that seek to make a difference in the world.
			</p>
		  ...
		  <div class="w3-padding-64 w3-content" id="photos">
		    ...
		    <div class="w3-row-padding" style="margin:0 -16px">
		      <div class="w3-half">
		        <img src="Images/15.jpg" style="width:50%" align="left">
		        <img src="Images/10.jpg" style="width:50%" align="right">
